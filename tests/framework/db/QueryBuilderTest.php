...
class QueryBuilderTest extends DatabaseTestCase
{
    ...
    public function columnTypes()
    {
        return [
            ...
            [Schema::TYPE_PK . ' UNSIGNED', $this->primaryKey()->unsigned(), 'int(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY'],
            [Schema::TYPE_PK . '(8) UNSIGNED', $this->primaryKey(8)->unsigned(), 'int(8) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY'],
            [Schema::TYPE_PK . ' UNSIGNED CHECK (value < 5)', $this->primaryKey()->unsigned()->check('value < 5'), 'int(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY CHECK (value < 5)'],
            ...
            [Schema::TYPE_INTEGER . ' UNSIGNED', $this->integer()->unsigned(), 'int(11) UNSIGNED'],
            [Schema::TYPE_INTEGER . '(8) UNSIGNED', $this->integer(8)->unsigned(), 'int(8) UNSIGNED'],
            [Schema::TYPE_INTEGER . '(8) UNSIGNED CHECK (value < 5)', $this->integer(8)->unsigned()->check('value < 5'), 'int(8) UNSIGNED CHECK (value < 5)'],
