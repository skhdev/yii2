...
class SqliteQueryBuilderTest extends QueryBuilderTest
{
    ...
    public function columnTypes()
    {
        return [
            ...
            [Schema::TYPE_PK . ' CHECK (value > 0)', $this->primaryKey()->unsigned(), 'integer PRIMARY KEY AUTOINCREMENT NOT NULL CHECK (value > 0)'],
            ...
            [Schema::TYPE_INTEGER . ' CHECK (value > 0)', $this->integer()->unsigned(), 'integer CHECK (value > 0)'],
