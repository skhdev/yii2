...
class CubridQueryBuilderTest extends QueryBuilderTest
{
    ...
    public function columnTypes()
    {
        return [
            ...
            [Schema::TYPE_PK . ' CHECK (value > 0)', $this->primaryKey()->unsigned(), 'int NOT NULL AUTO_INCREMENT PRIMARY KEY CHECK (value > 0)'],
            ...
            [Schema::TYPE_INTEGER . ' CHECK (value > 0)', $this->integer()->unsigned(), 'int CHECK (value > 0)'],
            [Schema::TYPE_INTEGER . ' CHECK (value < 5 AND value > 0)', $this->integer()->unsigned()->check('value < 5'), 'int CHECK (value < 5 AND value > 0)'],
